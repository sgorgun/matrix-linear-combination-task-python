...
```
cd existing_repo
git remote add origin https://gitlab.com/epam-gap-bs-ads/matrix-linear-combination-task-python.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/epam-gap-bs-ads/matrix-linear-combination-task-python/-/settings/integrations)
